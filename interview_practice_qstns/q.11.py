#Create three classes of three car brands - Ford, BMW, and Tesla. The attributes of the car's objects will be, model,
# color, year, transmission, and whether the car is electric or not (Boolean value.) Consider using inheritance in your answer.
